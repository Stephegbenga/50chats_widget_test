...
function onLoaded() {
const omniassistMessenger = document.getElementsByTagName(
"omniassist-messenger"
)[0];
...
button::-moz-focus-inner,[type="button"]::-moz-focus-inner,[type="reset"]::-moz-focus-inner,[type="submit"]::-moz-focus-inner { border-style: none; padding: 0;}button:-moz-focus,[type="button"]:-moz-focus,[type="reset"]:-moz-focus,[type="submit"]:-moz-focus { outline: 1px dotted ButtonText;}
...
let iframeInsideOmniassist =
omniassistMessenger.querySelector(".test-iframe");
let bgImageInsideOmniassist =
omniassistMessenger.querySelector(".test-container4");
let iconInsideOmniassist = omniassistMessenger.querySelector(".test-icon");


const animationName = clockwise ? 'rotate' : 'rotateCounterclockwise';
...
iconInsideOmniassist.style.animation = '';
iconInsideOmniassist.style.animation = `${animationName} 0.5s linear`
clockwise = !clockwise
} else {
...
iconInsideOmniassist.addEventListener('animationend',() => {
if(!show_variable){
